...
% where h(theta(x(i))k) is the result of the neural network forward propagation
...
% We should not regularise the bias term, in case of theta matrices its first column
% So we toss the first columns of each Theta(i) matrix.
